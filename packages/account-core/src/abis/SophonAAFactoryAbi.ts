export const sophonAAFactoryAbi = [
  {
    inputs: [
      {
      ...
      { internalType: 'address', name: '_passKeyModule', type: 'address' },
      { internalType: 'address', name: '_sessionKeyModule', type: 'address' },
    ],
  ...
  { inputs: [], name: 'EMPTY_BEACON_ADDRESS', type: 'error' },
  { inputs: [], name: 'EMPTY_BEACON_BYTECODE_HASH', type: 'error' },
  { inputs: [], name: 'EMPTY_PASSKEY_ADDRESS', type: 'error' },
  { inputs: [], name: 'EMPTY_SESSIONKEY_ADDRESS', type: 'error' },
  { inputs: [], name: 'INVALID_ACCOUNT_KEYS', type: 'error' },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes', name: 'passKey', type: 'bytes' },
      { internalType: 'bytes', name: 'sessionKey', type: 'bytes' },
      { internalType: 'address[]', name: 'ownerKeys', type: 'address[]' },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: 'address', name: 'factoryVersion', type: 'address' },
        ],
        internalType: 'struct AAFactory.Account',
        name: 'metadata',
        type: 'tuple',
      },
    ],
