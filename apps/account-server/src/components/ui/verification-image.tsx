...
export default function VerificationImage({
  ...
  return (
    <div className="relative">
      ...
      {/* Circle in front */}
      <div className="w-[66px] h-[66px] rounded-full border border-white/32 bg-white/32 shadow-[0_4px_8px_-4px_rgba(37,55,71,0.24),0_0px_24px_0px_rgba(255,255,255,0.92)_inset] backdrop-blur-xs relative z-40 flex items-center justify-center">
